...
const ProjectDesign = () => {
  return (
    <>
      <section id="project" className=" mx-auto px-4 pt-28 md:pt-24">
        <div className="flex flex-col justify-center">
          <div className="text-center md:flex md:flex-col md:justify-center lg:gap-4 md:w-[50%] md:mx-auto">
            <h1 className="text-3xl text-white font-bold items-center my-auto pb-3 lg:pb-0 lg:text-4xl">
              Design
            </h1>
            <p>
              These are my design portfolio. Created with love using Figma. Some
              of my work have been live.
            </p>
          </div>
